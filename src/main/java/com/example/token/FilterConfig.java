...
public class FilterConfig {
    ...
    public FilterRegistrationBean<JwtFilter> filterRegistrationBean(JwtFilter jwtFilter){
        ...
        filterReg.addUrlPatterns("/api/member1/update.do", "/api/member1/delete.do" ,"/api/customer/update.do","/api/customer/delete.do", "/api/seller/update.do", "/api/seller/delete.do");
