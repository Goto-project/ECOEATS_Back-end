...
public class TokenCreate {
    ...
    public Map<String, Object> validateCustomerToken(String token) {
        try {
            ...
            String customerPwd = (String) result.getPayload().get("customerPwd");
            String customerNickname = (String) result.getPayload().get("customerNickname");
            String customerPhone = (String) result.getPayload().get("customerPhone");
            
            System.out.println("Parsed Claims: " + result.getPayload()); 
            //추출한 정보 반환
            Map<String, Object> map = new HashMap<>();
            map.put("customerEmail", customerEmail);
            map.put("customerPwd", customerPwd);
            map.put("customerNickname", customerNickname);
